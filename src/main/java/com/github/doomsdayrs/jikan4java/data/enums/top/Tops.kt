 ...
 */
enum class Tops(private val type: String, val aClass: Class<*>) {
	ANIME("anime", AnimeTop::class.java),
	MANGA("manga", MangaTop::class.java),
	PEOPLE("people", PersonTop::class.java),
	CHARACTERS("characters", CharacterTop::class.java);

	fun compatible(topSubType: TopSubType): Boolean = topSubType.compatible(this)
